...
public class BSHelpPanel extends JPanel implements ActionListener {
	// Properties
	...
	public void paintComponent(Graphics g) {
		...
		for (int intRow = 0; intRow < 9; intRow++) {
			for (int intCol = 0; intCol < 9; intCol++) {
				...
				String[] strFullTileEnemy = strPlayerBoard[intRow][intCol].split(";");
	...
	// Constructor
	public BSHelpPanel() throws Exception {
		super();
